...
export class ConnectorService extends BaseService {
  ...
  public validateProperties(connectorTypeId: string, body: any): Promise<any> {
    // "[ConnectorService] Validating properties:",connectorTypeId
  ...
  public updateConnectorConfig(
    ...
    // "[ConnectorService] update a connector:");
  ...
  public getConnectors(clusterId: number): Promise<any[]> {
    // "[ConnectorService] Getting the list of connectors.");
  ...
  public getConnectorMetrics(
    ...
    // "[ConnectorService] Getting the connector metrics.");
  ...
  public restartConnectorTask(
    ...
    // "[ConnectorService] Restart the connector task");
  ...
  public getTransform(clusterId: number): Promise<any[]> {
    // "[ConnectorService] Getting the list of transform.");
